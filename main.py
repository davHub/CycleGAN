...
def main(args):
    ...
    with graph.as_default():
        cycGAN = CycleGAN(img_shape=[
                          args.fine_size, args.fine_size, 3], learning_rate=args.lr,  color_reg=args.color_reg, testing=args.testing, norm=args.norm,lambda_cyc=args.lambda_cyc)
    ...
    if (not args.testing):
        ...
        with tf.Session(graph=graph) as sess:
            ...
            cycGAN.train(sess, data, saver, tot_epochs=args.nb_epochs, batch_size = args.batch_size,
